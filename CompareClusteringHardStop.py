...
def output_seq_kmer_mapping_list(input_name, consensus_mapping_list, cluster_dict):
    ...
    output_list_file_name = "hard_stop" + input_name + "_mapping.p"
    ...
    output_score_file_name = "hard_stop" + input_name + "_score.p"
...
def main():
    ...
    for suffix_count in range(suffix_start_count, suffix_end_count + 1):
        ...
        pickle.dump(cluster_dict, open("clusters_hard_stop" + input_file_name + ".p", "wb"))
